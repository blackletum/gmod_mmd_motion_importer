...
MMDVMDNPC.I18N.en = {
    ...
    ["mmd_vmd_npc.ui.radial_wheel_help"] = "The wheel is bound to K by default (rebind in console: bind <key> +mmd_wheel). Hold the key to open the wheel, point at a motion, then release or click to play it on yourself — it builds automatically first if your playermodel has no cache yet. The top slot is always Stop. Each page shows up to 8 motions; scroll the mouse wheel to switch pages. Add or remove motions in the Motion Manager below (the Wheel column shows which motions are on it).",
    ["mmd_vmd_npc.radial.stop"] = "STOP",
    ["mmd_vmd_npc.radial.page_fmt"] = "Page %d / %d",
    ["mmd_vmd_npc.radial.scroll_hint"] = "Scroll to switch pages",
    ["mmd_vmd_npc.radial.default_bind"] = "MMD motion wheel bound to K. Rebind with: bind <key> +mmd_wheel",
    ...
    ["mmd_vmd_npc.camera.scale"] = "Position scale",
...
MMDVMDNPC.I18N.zh = merge_i18n({
    ...
    ["mmd_vmd_npc.radial.default_bind"] = "MMD 动作轮盘已绑定到 K 键。可用以下命令重绑：bind <键> +mmd_wheel",
...
MMDVMDNPC.I18N.ja = merge_i18n({
    ...
    ["mmd_vmd_npc.radial.default_bind"] = "MMDモーションホイールをKに割り当てました。再割り当て：bind <キー> +mmd_wheel",
    ...
    ["mmd_vmd_npc.camera.scale"] = "位置スケール",
