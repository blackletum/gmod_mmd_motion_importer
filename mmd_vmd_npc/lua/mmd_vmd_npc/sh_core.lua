...
MMDVMDNPC.I18N.en = {
    ...
    ["tool.mmd_vmd_npc.right_speed"] = "Open motion debug menu on clicked NPC",
...
MMDVMDNPC.I18N.zh = merge_i18n({
    ...
    ["tool.mmd_vmd_npc.right_speed"] = "在点击的 NPC 上打开动作调试菜单",
...
MMDVMDNPC.I18N.ja = merge_i18n({
    ...
    ["tool.mmd_vmd_npc.right_speed"] = "クリックした NPC のモーションデバッグを開く",
...
MMDVMDNPC.I18N.ko = merge_i18n({
    ...
    ["tool.mmd_vmd_npc.right_speed"] = " 클릭한 NPC의 모션 디버그 열기",
...
MMDVMDNPC.I18N.fr = merge_i18n({
    ...
    ["tool.mmd_vmd_npc.right_speed"] = "+ Maj : ouvrir le menu de débogage sur le PNJ cliqué",
...
MMDVMDNPC.I18N.ru = merge_i18n({
    ...
    ["tool.mmd_vmd_npc.right_speed"] = " открыть отладку движения на NPC",
...
MMDVMDNPC.I18N.ar = merge_i18n({
    ...
    ["tool.mmd_vmd_npc.right_speed"] = " فتح قائمة تصحيح الحركة على الشخصية",
...
MMDVMDNPC.I18N.es = merge_i18n({
    ...
    ["tool.mmd_vmd_npc.right_speed"] = "Abrir el menú de depuración en el NPC clicado",
